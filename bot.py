...
POST_TEST_REFERRAL_TRUDVSEM = (
    ...
    'портал «Работа России» trudvsem.ru или обратиться лично к специалисту-профконсультанту в Кадровый центр '
    '«Работа России» города Ижевска и Завьяловского района.'
)
...
CAREER_HINTS_DDO = {
    ...
    "Ч-Х": "🎨 Человек-Художественный образ\n\nТебе подходят творческие профессии: дизайнер, художник, музыкант, актёр, писатель, архитектор.\n\nРекомендация: развивай творческие способности, изучай искусство.",
}
